...
type VirtualHostOption struct {
	...
	//	*VirtualHostOption_Status
	//	*VirtualHostOption_NamespacedStatuses
	StatusOneof isVirtualHostOption_StatusOneof `protobuf_oneof:"status_oneof"`
...
func (m *VirtualHostOption) GetStatusOneof() isVirtualHostOption_StatusOneof {
	if m != nil {
...
func (x *VirtualHostOption) GetStatus() *core.Status {
	if x, ok := x.GetStatusOneof().(*VirtualHostOption_Status); ok {
		return x.Status
	}
	return nil
}
...
func (x *VirtualHostOption) GetNamespacedStatuses() *core.NamespacedStatuses {
	if x, ok := x.GetStatusOneof().(*VirtualHostOption_NamespacedStatuses); ok {
...
type isVirtualHostOption_StatusOneof interface {
	isVirtualHostOption_StatusOneof()
}

type VirtualHostOption_Status struct {
...
type VirtualHostOption_NamespacedStatuses struct {
...
func (*VirtualHostOption_Status) isVirtualHostOption_StatusOneof() {}

func (*VirtualHostOption_NamespacedStatuses) isVirtualHostOption_StatusOneof() {}
...
type RouteOption struct {
	...
	// Types that are assignable to StatusOneof:
	//	*RouteOption_Status
	//	*RouteOption_NamespacedStatuses
	StatusOneof isRouteOption_StatusOneof `protobuf_oneof:"status_oneof"`
	// Metadata contains the object metadata for this resource
	Metadata *core.Metadata `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (m *RouteOption) GetStatusOneof() isRouteOption_StatusOneof {
	if m != nil {
		return m.StatusOneof
	}
	return nil
...
func (x *RouteOption) GetStatus() *core.Status {
	if x, ok := x.GetStatusOneof().(*RouteOption_Status); ok {
		return x.Status
	}
	return nil
}
...
func (x *RouteOption) GetNamespacedStatuses() *core.NamespacedStatuses {
	if x, ok := x.GetStatusOneof().(*RouteOption_NamespacedStatuses); ok {
		return x.NamespacedStatuses
	}
	return nil
}
...
type isRouteOption_StatusOneof interface {
	isRouteOption_StatusOneof()
}

type RouteOption_Status struct {
	// Status indicates the validation status of this resource.
	// Status is read-only by clients, and set by gloo during validation
	Status *core.Status `protobuf:"bytes,1,opt,name=status,proto3,oneof"`
}

type RouteOption_NamespacedStatuses struct {
	NamespacedStatuses *core.NamespacedStatuses `protobuf:"bytes,4,opt,name=namespaced_statuses,json=namespacedStatuses,proto3,oneof"`
}

func (*RouteOption_Status) isRouteOption_StatusOneof() {}

func (*RouteOption_NamespacedStatuses) isRouteOption_StatusOneof() {}
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_external_options_proto_rawDesc = []byte{
	...
	0x2f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcc,
	0x02, 0x0a, 0x11, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x48, 0x6f, 0x73, 0x74, 0x4f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01,
	...
	0x48, 0x00, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x59, 0x0a, 0x13, 0x6e, 0x61,
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x73,
	0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65,
	0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x42, 0x04, 0xb8, 0xf5, 0x04, 0x01, 0x48,
	0x00, 0x52, 0x12, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x64, 0x53, 0x74, 0x61,
	...
	0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x3a, 0x0a, 0x07, 0x6f, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x67, 0x6c, 0x6f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x3a, 0x26, 0x82, 0xf1, 0x04, 0x08, 0x0a, 0x06, 0x76, 0x68, 0x6f,
	0x70, 0x74, 0x73, 0x82, 0xf1, 0x04, 0x16, 0x12, 0x14, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c,
	0x5f, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x0e, 0x0a,
	0x0c, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x22, 0xb9, 0x02,
	0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a,
	...
	0x74, 0x75, 0x73, 0x12, 0x59, 0x0a, 0x13, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65,
	0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x73, 0x42, 0x04, 0xb8, 0xf5, 0x04, 0x01, 0x48, 0x00, 0x52, 0x12, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x74, 0x61, 0x12, 0x34, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20,
	...
	0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x3a, 0x1f, 0x82, 0xf1, 0x04, 0x08, 0x0a, 0x06,
	0x72, 0x74, 0x6f, 0x70, 0x74, 0x73, 0x82, 0xf1, 0x04, 0x0f, 0x12, 0x0d, 0x72, 0x6f, 0x75, 0x74,
	0x65, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x0e, 0x0a, 0x0c, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x5f, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x42, 0x3d, 0x5a, 0x33, 0x67, 0x69, 0x74,
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_external_options_proto_goTypes = []interface{}{
	...
	(*v1.VirtualHostOptions)(nil),   // 5: gloo.solo.io.VirtualHostOptions
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_external_options_proto_depIdxs = []int32{
	...
	3, // 1: gateway.solo.io.VirtualHostOption.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	4, // 2: gateway.solo.io.VirtualHostOption.metadata:type_name -> core.solo.io.Metadata
	5, // 3: gateway.solo.io.VirtualHostOption.options:type_name -> gloo.solo.io.VirtualHostOptions
	2, // 4: gateway.solo.io.RouteOption.status:type_name -> core.solo.io.Status
	3, // 5: gateway.solo.io.RouteOption.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	4, // 6: gateway.solo.io.RouteOption.metadata:type_name -> core.solo.io.Metadata
	6, // 7: gateway.solo.io.RouteOption.options:type_name -> gloo.solo.io.RouteOptions
...
func file_github_com_solo_io_gloo_projects_gateway_api_v1_external_options_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gateway_api_v1_external_options_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*VirtualHostOption_Status)(nil),
		(*VirtualHostOption_NamespacedStatuses)(nil),
	}
	file_github_com_solo_io_gloo_projects_gateway_api_v1_external_options_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*RouteOption_Status)(nil),
		(*RouteOption_NamespacedStatuses)(nil),
	}
	type x struct{}
