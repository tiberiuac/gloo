...
// source: github.com/solo-io/gloo-edge/projects/gateway/api/v1/virtual_service.proto
...
func (RouteTableSelector_Expression_Operator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{4, 1, 0}
}
...
func (*VirtualService) Descriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{0}
}
...
//
//Unlike the [Gloo Virtual Host]({{< ref "/reference/api/github.com/solo-io/gloo-edge/projects/gloo/api/v1/proxy.proto.sk.md" >}}/#virtualhost),
...
func (*VirtualHost) Descriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{1}
}
...
// - *Delegate* the action for the request to one or more top-level [`RouteTable`]({{< ref "/reference/api/github.com/solo-io/gloo-edge/projects/gateway/api/v1/route_table.proto.sk.md" >}}) resources
...
func (*Route) Descriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{2}
}
...
func (*DelegateAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{3}
}
...
func (*RouteTableSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{4}
}
...
func (*RouteTableSelector_Expression) Descriptor() ([]byte, []int) {
	return fileDescriptor_62ecc3c84f4ac132, []int{4, 1}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gateway/api/v1/virtual_service.proto", fileDescriptor_62ecc3c84f4ac132)
}

var fileDescriptor_62ecc3c84f4ac132 = []byte{
	...
	,
}
