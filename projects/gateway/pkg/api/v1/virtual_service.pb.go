...
func (RouteTableSelector_Expression_Operator) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_rawDescGZIP(), []int{4, 1, 0}
}
...
func (x *RouteTableSelector_Expression) Reset() {
	*x = RouteTableSelector_Expression{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RouteTableSelector_Expression) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_rawDescGZIP(), []int{4, 1}
}
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xba, 0x02, 0x0a, 0x0e, 0x56,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x3a, 0x1e, 0x82, 0xf1, 0x04, 0x04, 0x0a, 0x02, 0x76,
	0x73, 0x82, 0xf1, 0x04, 0x12, 0x12, 0x10, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x5f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x93, 0x01, 0x0a, 0x0b, 0x56, 0x69, 0x72, 0x74,
	...
	0x73, 0x12, 0x2e, 0x0a, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x16, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x73, 0x6f, 0x6c, 0x6f,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xf4, 0x04,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xcf, 0x01, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74,
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_goTypes = []interface{}{
	...
	(*DelegateAction)(nil),                      // 4: gateway.solo.io.DelegateAction
	(*RouteTableSelector)(nil),                  // 5: gateway.solo.io.RouteTableSelector
	nil,                                         // 6: gateway.solo.io.RouteTableSelector.LabelsEntry
	(*RouteTableSelector_Expression)(nil),       // 7: gateway.solo.io.RouteTableSelector.Expression
	(*v1.SslConfig)(nil),                        // 8: gloo.solo.io.SslConfig
	(*core.Status)(nil),                         // 9: core.solo.io.Status
	(*core.Metadata)(nil),                       // 10: core.solo.io.Metadata
	(*v1.VirtualHostOptions)(nil),               // 11: gloo.solo.io.VirtualHostOptions
	(*matchers.Matcher)(nil),                    // 12: matchers.core.gloo.solo.io.Matcher
	(*wrappers.BoolValue)(nil),                  // 13: google.protobuf.BoolValue
	(*v1.RouteAction)(nil),                      // 14: gloo.solo.io.RouteAction
	(*v1.RedirectAction)(nil),                   // 15: gloo.solo.io.RedirectAction
	(*v1.DirectResponseAction)(nil),             // 16: gloo.solo.io.DirectResponseAction
	(*v1.RouteOptions)(nil),                     // 17: gloo.solo.io.RouteOptions
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_depIdxs = []int32{
	...
	8,  // 1: gateway.solo.io.VirtualService.ssl_config:type_name -> gloo.solo.io.SslConfig
	9,  // 2: gateway.solo.io.VirtualService.status:type_name -> core.solo.io.Status
	10, // 3: gateway.solo.io.VirtualService.metadata:type_name -> core.solo.io.Metadata
	3,  // 4: gateway.solo.io.VirtualHost.routes:type_name -> gateway.solo.io.Route
	11, // 5: gateway.solo.io.VirtualHost.options:type_name -> gloo.solo.io.VirtualHostOptions
	12, // 6: gateway.solo.io.Route.matchers:type_name -> matchers.core.gloo.solo.io.Matcher
	13, // 7: gateway.solo.io.Route.inheritable_matchers:type_name -> google.protobuf.BoolValue
	13, // 8: gateway.solo.io.Route.inheritable_path_matchers:type_name -> google.protobuf.BoolValue
	14, // 9: gateway.solo.io.Route.route_action:type_name -> gloo.solo.io.RouteAction
	15, // 10: gateway.solo.io.Route.redirect_action:type_name -> gloo.solo.io.RedirectAction
	16, // 11: gateway.solo.io.Route.direct_response_action:type_name -> gloo.solo.io.DirectResponseAction
	4,  // 12: gateway.solo.io.Route.delegate_action:type_name -> gateway.solo.io.DelegateAction
	17, // 13: gateway.solo.io.Route.options:type_name -> gloo.solo.io.RouteOptions
	18, // 14: gateway.solo.io.DelegateAction.ref:type_name -> core.solo.io.ResourceRef
	5,  // 15: gateway.solo.io.DelegateAction.selector:type_name -> gateway.solo.io.RouteTableSelector
	6,  // 16: gateway.solo.io.RouteTableSelector.labels:type_name -> gateway.solo.io.RouteTableSelector.LabelsEntry
	7,  // 17: gateway.solo.io.RouteTableSelector.expressions:type_name -> gateway.solo.io.RouteTableSelector.Expression
	0,  // 18: gateway.solo.io.RouteTableSelector.Expression.operator:type_name -> gateway.solo.io.RouteTableSelector.Expression.Operator
...
func file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_gloo_projects_gateway_api_v1_virtual_service_proto_msgTypes[3].OneofWrappers = []interface{}{
