...
func (r *RouteOption) SetNamespacedStatuses(status *core.NamespacedStatuses) {
	r.StatusOneof = &RouteOption_NamespacedStatuses{NamespacedStatuses: status}
}
...
func (r *RouteOption) UpsertNamespacedStatus(status *core.Status) error {
...
// Note: POD_NAMESPACE environment variable must be set for this function to behave as expected.
// If unset, a podNamespaceErr is returned.
func (r *RouteOption) GetNamespacedStatus() (*core.Status, error) {
	podNamespace := os.Getenv("POD_NAMESPACE")
	if podNamespace == "" {
