...
func (m *Gateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.Gateway")); err != nil {
		return 0, err
	}
...
func (m *HttpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.HttpGateway")); err != nil {
		return 0, err
	}
...
func (m *TcpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.TcpGateway")); err != nil {
		return 0, err
	}
