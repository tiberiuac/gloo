...
func (m *VirtualService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.VirtualService")); err != nil {
		return 0, err
	}
...
func (m *VirtualHost) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.VirtualHost")); err != nil {
		return 0, err
	}
...
func (m *Route) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.Route")); err != nil {
		return 0, err
	}
...
func (m *DelegateAction) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.DelegateAction")); err != nil {
		return 0, err
	}
...
func (m *RouteTableSelector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.RouteTableSelector")); err != nil {
		return 0, err
	}
...
func (m *RouteTableSelector_Expression) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo-edge/projects/gateway/pkg/api/v1.RouteTableSelector_Expression")); err != nil {
		return 0, err
	}
