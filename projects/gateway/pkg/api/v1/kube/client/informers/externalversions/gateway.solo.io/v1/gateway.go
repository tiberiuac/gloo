	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV1().Gateways(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1().Gateways(namespace).Watch(options)
			},
		},
		&gatewaysoloiov1.Gateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewaysoloiov1.Gateway{}, f.defaultInformer)
}
