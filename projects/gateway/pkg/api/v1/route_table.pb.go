...
type RouteTable struct {
	...
	//	*RouteTable_Status
	//	*RouteTable_ReporterStatus
	StatusOneof isRouteTable_StatusOneof `protobuf_oneof:"status_oneof"`
...
func (m *RouteTable) GetStatusOneof() isRouteTable_StatusOneof {
	if m != nil {
...
func (x *RouteTable) GetStatus() *core.Status {
	if x, ok := x.GetStatusOneof().(*RouteTable_Status); ok {
		return x.Status
	}
	return nil
}

func (x *RouteTable) GetReporterStatus() *core.ReporterStatus {
	if x, ok := x.GetStatusOneof().(*RouteTable_ReporterStatus); ok {
...
type isRouteTable_StatusOneof interface {
	isRouteTable_StatusOneof()
}
...
type RouteTable_ReporterStatus struct {
	ReporterStatus *core.ReporterStatus `protobuf:"bytes,8,opt,name=reporter_status,json=reporterStatus,proto3,oneof"`
}

func (*RouteTable_Status) isRouteTable_StatusOneof() {}

func (*RouteTable_ReporterStatus) isRouteTable_StatusOneof() {}
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_route_table_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd6, 0x02, 0x0a, 0x0a, 0x52, 0x6f, 0x75, 0x74, 0x65,
	...
	,
	...
	0x61, 0x74, 0x61, 0x3a, 0x1a, 0x82, 0xf1, 0x04, 0x04, 0x0a, 0x02, 0x72, 0x74, 0x82, 0xf1, 0x04,
	0x0e, 0x12, 0x0c, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x42,
...
var file_github_com_solo_io_gloo_projects_gateway_api_v1_route_table_proto_depIdxs = []int32{
	...
	3, // 2: gateway.solo.io.RouteTable.status:type_name -> core.solo.io.Status
	4, // 3: gateway.solo.io.RouteTable.reporter_status:type_name -> core.solo.io.ReporterStatus
	5, // 4: gateway.solo.io.RouteTable.metadata:type_name -> core.solo.io.Metadata
...
func file_github_com_solo_io_gloo_projects_gateway_api_v1_route_table_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gateway_api_v1_route_table_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*RouteTable_Status)(nil),
		(*RouteTable_ReporterStatus)(nil),
	}
	type x struct{}
