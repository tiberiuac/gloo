...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/extensions/filters/http/wasm/v3/wasm.proto", fileDescriptor_a4a50b3626ddabde)
}
