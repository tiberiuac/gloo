...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/extensions/filters/http/buffer/v3/buffer.proto", fileDescriptor_7e9fce05f80b94cf)
}
