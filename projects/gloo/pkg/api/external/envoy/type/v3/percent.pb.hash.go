...
func (m *Percent) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.type.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/type/v3.Percent")); err != nil {
		return 0, err
	}
...
func (m *FractionalPercent) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.type.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/type/v3.FractionalPercent")); err != nil {
		return 0, err
	}
