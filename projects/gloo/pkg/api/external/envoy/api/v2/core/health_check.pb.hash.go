...
func (m *HealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_Payload) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck_Payload")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_HttpHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck_HttpHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_TcpHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck_TcpHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_RedisHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck_RedisHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_GrpcHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck_GrpcHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_CustomHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.core.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/core.HealthCheck_CustomHealthCheck")); err != nil {
		return 0, err
	}
