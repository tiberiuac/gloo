...
// source: github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/api/v2/config/wasm/wasm.proto
...
func (m *VmConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.wasm.v2.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/config.VmConfig")); err != nil {
		return 0, err
	}
...
func (m *PluginConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.wasm.v2.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/config.PluginConfig")); err != nil {
		return 0, err
	}
...
func (m *WasmService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.wasm.v2.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/config.WasmService")); err != nil {
		return 0, err
	}
