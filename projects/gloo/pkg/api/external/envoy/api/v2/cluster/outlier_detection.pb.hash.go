...
func (m *OutlierDetection) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.cluster.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/api/v2/cluster.OutlierDetection")); err != nil {
		return 0, err
	}
