...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/api/v2/cluster/outlier_detection.proto", fileDescriptor_d66ea649b88221e5)
}
