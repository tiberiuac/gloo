...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/config/filter/http/gzip/v2/gzip.proto", fileDescriptor_1affeaf387577671)
}
