...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/config/route/v3/route_components.proto", fileDescriptor_c7fa53e16a8d211a)
}
