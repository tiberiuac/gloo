...
func (m *Pipe) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.core.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/config/core/v3.Pipe")); err != nil {
		return 0, err
	}
...
func (m *SocketAddress) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.core.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/config/core/v3.SocketAddress")); err != nil {
		return 0, err
	}
...
func (m *TcpKeepalive) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.core.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/config/core/v3.TcpKeepalive")); err != nil {
		return 0, err
	}
...
func (m *BindConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.core.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/config/core/v3.BindConfig")); err != nil {
		return 0, err
	}
...
func (m *Address) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.core.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/config/core/v3.Address")); err != nil {
		return 0, err
	}
...
func (m *CidrRange) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.core.v3.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/external/envoy/config/core/v3.CidrRange")); err != nil {
		return 0, err
	}
