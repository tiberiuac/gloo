...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/external/envoy/config/core/v3/event_service_config.proto", fileDescriptor_7f2fc7138363c06b)
}
