...
func (m *Matcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/core/matchers.Matcher")); err != nil {
		return 0, err
	}
...
func (m *HeaderMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/core/matchers.HeaderMatcher")); err != nil {
		return 0, err
	}
...
func (m *QueryParameterMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/core/matchers.QueryParameterMatcher")); err != nil {
		return 0, err
	}
