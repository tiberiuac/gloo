...
func (m *Endpoint) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1.Endpoint")); err != nil {
		return 0, err
	}
...
func (m *HealthCheckConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1.HealthCheckConfig")); err != nil {
		return 0, err
	}
