...
// source: github.com/solo-io/gloo-edge/projects/gloo/api/v1/ssl.proto
...
func (SslParameters_ProtocolVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{5, 0}
}
...
func (*SslConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{0}
}
...
func (*SSLFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{1}
}
...
func (*UpstreamSslConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{2}
}
...
func (*SDSConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{3}
}
...
func (*CallCredentials) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{4}
}
...
func (*CallCredentials_FileCredentialSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{4, 0}
}
...
func (*SslParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_b820b0485c4a3387, []int{5}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/v1/ssl.proto", fileDescriptor_b820b0485c4a3387)
}

var fileDescriptor_b820b0485c4a3387 = []byte{
	...
	,
}
