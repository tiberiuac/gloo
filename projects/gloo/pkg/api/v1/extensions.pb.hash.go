...
func (m *Extensions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1.Extensions")); err != nil {
		return 0, err
	}
...
func (m *Extension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1.Extension")); err != nil {
		return 0, err
	}
