...
func (r *Upstream) SetNamespacedStatuses(status *core.NamespacedStatuses) {
	r.StatusOneof = &Upstream_NamespacedStatuses{NamespacedStatuses: status}
}
...
func (r *Upstream) UpsertNamespacedStatus(status *core.Status) error {
