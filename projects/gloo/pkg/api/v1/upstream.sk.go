...
func (r *Upstream) AddToReporterStatus(status *core.Status) {
...
// Note: POD_NAMESPACE environment variable must be set for this function to behave as expected.
func (r *Upstream) GetStatusForReporter(reportedBy string) *core.Status {
	podNamespace := os.Getenv("POD_NAMESPACE")
	if podNamespace != "" {
...
func (r *Upstream) HasReporterStatus() bool {
...
func (r *Upstream) HasStatus() bool {
	switch r.StatusOneof.(type) {
