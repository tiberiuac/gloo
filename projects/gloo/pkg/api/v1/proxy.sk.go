...
func (r *Proxy) SetNamespacedStatuses(status *core.NamespacedStatuses) {
	r.StatusOneof = &Proxy_NamespacedStatuses{NamespacedStatuses: status}
}
...
func (r *Proxy) UpsertNamespacedStatus(status *core.Status) error {
