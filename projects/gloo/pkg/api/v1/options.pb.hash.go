...
func (m *VirtualHostOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetOptionsRefs()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("OptionsRefs")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetOptionsRefs(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("OptionsRefs")); err != nil {
				return 0, err
...
func (m *VirtualHostOption) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.VirtualHostOption")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *VirtualHostOptionRefs) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.VirtualHostOptionRefs")); err != nil {
		return 0, err
	}
...
func (m *RouteOption) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.RouteOption")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *RouteOptionRefs) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.RouteOptionRefs")); err != nil {
		return 0, err
	}
