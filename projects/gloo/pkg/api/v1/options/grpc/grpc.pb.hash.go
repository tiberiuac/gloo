...
func (m *ServiceSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("grpc.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/grpc.ServiceSpec")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("grpc.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/grpc.DestinationSpec")); err != nil {
		return 0, err
	}
...
func (m *ServiceSpec_GrpcService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("grpc.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/grpc.ServiceSpec_GrpcService")); err != nil {
		return 0, err
	}
