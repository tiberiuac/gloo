...
func (m *UpstreamSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/aws.UpstreamSpec")); err != nil {
		return 0, err
	}
...
func (m *LambdaFunctionSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/aws.LambdaFunctionSpec")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/aws.DestinationSpec")); err != nil {
		return 0, err
	}
