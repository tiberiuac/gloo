...
func (m *UpstreamSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws_ec2.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/aws/ec2.UpstreamSpec")); err != nil {
		return 0, err
	}
...
func (m *TagFilter) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws_ec2.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/aws/ec2.TagFilter")); err != nil {
		return 0, err
	}
...
func (m *TagFilter_KvPair) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws_ec2.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/aws/ec2.TagFilter_KvPair")); err != nil {
		return 0, err
	}
