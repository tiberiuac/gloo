...
func (m *RouteActionHashConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("lbhash.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/lbhash.RouteActionHashConfig")); err != nil {
		return 0, err
	}
...
func (m *Cookie) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("lbhash.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/lbhash.Cookie")); err != nil {
		return 0, err
	}
...
func (m *HashPolicy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("lbhash.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/lbhash.HashPolicy")); err != nil {
		return 0, err
	}
