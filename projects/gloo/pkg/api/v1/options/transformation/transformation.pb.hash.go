...
func (m *ResponseMatch) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/transformation.ResponseMatch")); err != nil {
		return 0, err
	}
...
func (m *RequestMatch) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/transformation.RequestMatch")); err != nil {
		return 0, err
	}
...
func (m *Transformations) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/transformation.Transformations")); err != nil {
		return 0, err
	}
...
func (m *RequestResponseTransformations) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/transformation.RequestResponseTransformations")); err != nil {
		return 0, err
	}
...
func (m *TransformationStages) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/transformation.TransformationStages")); err != nil {
		return 0, err
	}
