...
func (m *ListenerTracingSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/tracing.ListenerTracingSettings")); err != nil {
		return 0, err
	}
...
func (m *RouteTracingSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/tracing.RouteTracingSettings")); err != nil {
		return 0, err
	}
...
func (m *TracePercentages) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/tracing.TracePercentages")); err != nil {
		return 0, err
	}
