...
// source: github.com/solo-io/gloo-edge/projects/gloo/api/v1/options/wasm/wasm.proto
...
func (WasmFilter_VmType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd11abcc55489ded, []int{1, 0}
}
...
func (FilterStage_Stage) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd11abcc55489ded, []int{2, 0}
}
...
func (FilterStage_Predicate) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd11abcc55489ded, []int{2, 1}
}
...
func (*PluginSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd11abcc55489ded, []int{0}
}
...
func (*WasmFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd11abcc55489ded, []int{1}
}
...
func (*FilterStage) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd11abcc55489ded, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/v1/options/wasm/wasm.proto", fileDescriptor_bd11abcc55489ded)
}

var fileDescriptor_bd11abcc55489ded = []byte{
	// 546 bytes of a gzipped FileDescriptorProto
	,
}
