...
func (m *PluginSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("wasm.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/wasm.PluginSource")); err != nil {
		return 0, err
	}
...
func (m *WasmFilter) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("wasm.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/wasm.WasmFilter")); err != nil {
		return 0, err
	}
...
func (m *FilterStage) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("wasm.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/wasm.FilterStage")); err != nil {
		return 0, err
	}
