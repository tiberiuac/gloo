...
func (m *ServiceSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rest.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/rest.ServiceSpec")); err != nil {
		return 0, err
	}
...
func (m *DestinationSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rest.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/rest.DestinationSpec")); err != nil {
		return 0, err
	}
...
func (m *ServiceSpec_SwaggerInfo) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rest.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/options/rest.ServiceSpec_SwaggerInfo")); err != nil {
		return 0, err
	}
