...
func (m *FilterConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dlp.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/dlp.FilterConfig")); err != nil {
		return 0, err
	}
...
func (m *DlpRule) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dlp.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/dlp.DlpRule")); err != nil {
		return 0, err
	}
...
func (m *Config) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dlp.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/dlp.Config")); err != nil {
		return 0, err
	}
...
func (m *Action) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dlp.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/dlp.Action")); err != nil {
		return 0, err
	}
...
func (m *CustomAction) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dlp.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/dlp.CustomAction")); err != nil {
		return 0, err
	}
