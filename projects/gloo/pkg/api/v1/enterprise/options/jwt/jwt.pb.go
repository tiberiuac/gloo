...
// source: github.com/solo-io/gloo-edge/projects/gloo/api/v1/enterprise/options/jwt/jwt.proto
...
func (*VhostExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{0}
}
...
func (*RouteExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{1}
}
...
func (*Provider) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{2}
}
...
func (*Jwks) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{3}
}
...
func (*RemoteJwks) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{4}
}
...
func (*LocalJwks) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{5}
}
...
func (*TokenSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{6}
}
...
func (*TokenSource_HeaderSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{6, 0}
}
...
func (*ClaimToHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_187167e5b776319d, []int{7}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo-edge/projects/gloo/api/v1/enterprise/options/jwt/jwt.proto", fileDescriptor_187167e5b776319d)
}

var fileDescriptor_187167e5b776319d = []byte{
	// 703 bytes of a gzipped FileDescriptorProto
	,
}
