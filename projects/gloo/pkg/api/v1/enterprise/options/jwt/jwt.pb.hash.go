...
func (m *VhostExtension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.VhostExtension")); err != nil {
		return 0, err
	}
...
func (m *RouteExtension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.RouteExtension")); err != nil {
		return 0, err
	}
...
func (m *Provider) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.Provider")); err != nil {
		return 0, err
	}
...
func (m *Jwks) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.Jwks")); err != nil {
		return 0, err
	}
...
func (m *RemoteJwks) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.RemoteJwks")); err != nil {
		return 0, err
	}
...
func (m *LocalJwks) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.LocalJwks")); err != nil {
		return 0, err
	}
...
func (m *TokenSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.TokenSource")); err != nil {
		return 0, err
	}
...
func (m *ClaimToHeader) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.ClaimToHeader")); err != nil {
		return 0, err
	}
...
func (m *TokenSource_HeaderSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/gloo-edge/projects/gloo/pkg/api/v1/enterprise/options/jwt.TokenSource_HeaderSource")); err != nil {
		return 0, err
	}
