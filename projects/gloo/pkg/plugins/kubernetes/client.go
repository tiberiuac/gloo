...
//go:generate mockgen -destination ./mocks/kubesharedfactory_mock.go github.com/solo-io/gloo-edge/projects/gloo/pkg/plugins/kubernetes KubePluginSharedFactory
