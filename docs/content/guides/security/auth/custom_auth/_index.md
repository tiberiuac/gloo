...
[this file](https://github.com/solo-io/gloo-edge/blob/v1.3.2/docs/content/security/auth/custom_auth/auth-service.yaml) 
...
[this manifest](https://github.com/solo-io/gloo-edge/blob/v1.3.2/docs/content/security/auth/custom_auth/gloo-vs.yaml) 
