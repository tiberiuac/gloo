...
##### Source File: [github.com/solo-io/gloo-edge/projects/gloo/api/v1/settings.proto](https://github.com/solo-io/gloo-edge/blob/master/projects/gloo/api/v1/settings.proto)
...
| `enableRestEds` | [.google.protobuf.BoolValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/bool-value) | Whether or not to use rest xds for all EDS by default. Set to true by default in versions > `v1.6.0`. This setting is meant to solve the bug which causes updated upstreams to dissapear, or have 0 endpoints. Some examples are: 1. https://github.com/solo-io/gloo-edge/issues/3673 2. https://github.com/solo-io/gloo-edge/issues/3710 3. https://github.com/solo-io/gloo-edge/issues/3219 Rest XDS, as opposed to grpc, uses http polling rather than streaming. |  |
