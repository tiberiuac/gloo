...
| `transformerConfig` | [.solo.io.envoy.config.core.v3.TypedExtensionConfig](../../../config/core/v3/extension.proto.sk/#typedextensionconfig) | An extension point for BYO transformer. Only one of `transformerConfig`, or `headerBodyTransform` can be set. |
